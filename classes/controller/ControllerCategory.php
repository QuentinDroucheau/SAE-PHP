...
class ControllerCategory extends Controller
{
  public function view(): void
  {
    ...
    if ($category == "artistes") {
      ...
      $albums = AlbumDB::getAllAlbumsByCategory($category, null, null, null, $idUtilisateur);
  ...
  public function filtreView(): void
  {
    ...
    if (isset($year) || isset($genre) || isset($artistId)) {
      $albums = AlbumDB::getAllAlbumsByCategory($category, $year, $genreSelec, (int) $artisteId, $idUtilisateur);
    } else {
      if ($category == "artistes") {
